  ...
  <div class="grid lg:grid-cols-2 sm:grid-cols-1 gap-3">
    <FlexContainer>
      <template #feature-content>
        <img src="@/assets/flutter-logo.svg" alt="Nuxt" class="w-32 lg:mr-3">
      </template>
      <template #content>
        ...
        <p>
          A Hybrid framework for building native application on Android, iOS, Web, Windows, Mac and Linux
          <br>
          I built a project which was the winner of the Universidad Complutense de Madrid Hackaton
        </p>
      </template>
    </FlexContainer>
    <FlexContainer>
      <template #feature-content>
        <div class="w-32 lg:mr-3">
      ...
      <template #content>
        ...
        <p>
          A Hybrid Web framework for building native application on Android, iOS and Web. Fully based on web technologies
          <br>
          I have used this framework extensively throughout many different university projects
        </p>
      </template>
    </FlexContainer>
  </div>
